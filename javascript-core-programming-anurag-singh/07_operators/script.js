...
// Combined Assignment (Compound Operators) Operator in JS
...
// To apply increment and decrement, we cannot use const to declare variable as const does not allow reassignment
